...
import { addToDb, clearLocalStorage } from "../LocalStorage/Database";
...
const Shop = () => {
  ...
  const addToCart = (productDetails) => {
    let newCartProduct = [];
      console.log("Cartproduct is :-",typeof cartProduct);
       const checkProductExistence = cartProduct && cartProduct.find(
